...
class _OnBordingScreenState extends State<OnBordingScreen> {
  ...
  final List<Onbord> _onbordData = [
    ...
    Onbord(
      ...
      title: "Get those my_libraryping \nbags filled",
      description:
    ...
    Onbord(
      ...
      description:
          "In particular, my_librarylon can pack your orders, and help you seamlessly manage your shipments.",
    ),
    Onbord(
      ...
      title: "Nearby stores",
      description:
          "Easily track nearby my_librarys, browse through their items and get information about their prodcuts.",
    ),
  ];
